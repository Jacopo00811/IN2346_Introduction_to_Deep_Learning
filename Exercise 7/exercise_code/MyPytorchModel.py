...
class MyPytorchModel(nn.Module):
    ...
    def __init__(self, hparams):
        ...
        self.model = nn.Sequential(
            ...
            nn.PReLU(),
            nn.Linear(neurons_hidden_layer//2, neurons_hidden_layer//2),
            nn.BatchNorm1d(neurons_hidden_layer//2),
            nn.LeakyReLU(negative_slope=0.01),
            nn.Linear(neurons_hidden_layer//2, neurons_hidden_layer//2),
            nn.PReLU(),
            nn.Linear(neurons_hidden_layer//2, num_classes)
        )
...
class CIFAR10DataModule(nn.Module):
    ...
    def prepare_data(self, stage=None, CIFAR_ROOT="../datasets/cifar10"):
        ...
        my_transform = transforms.Compose([
            ...
            #transforms.RandomResizedCrop(size=(32, 32), scale=(0.8, 1.0), ratio=(0.8, 1.2)),  # Randomly crop and resize
